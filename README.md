...
### 1. `slides/`
This folder contains all the lecture slides used throughout the course. Each lecture will have its own pptx file, named according to the lecture topic and date. These slides will be updated regularly, so please make sure to check this folder before each class.

```
slides/
├── Topic 1 - Python essentials.pptx
├── Topic 2 - Numerical computation & Scientific Simulation.pptx
└── ...
```

### 2. `notebooks/`
This folder contains Google Colab notebooks that will be used during the course for hands-on exercises and assignments. Each notebook is designed to help you apply the concepts learned in the lectures through practical examples. Notebooks will be named based on the lecture or topic they correspond to.

```
colabs/
├── S1_intro_Python.ipynb
├── S2_numerical_computation.ipynb
└── ...
```
...
If you encounter any issues or have suggestions for improving the course materials, feel free to contribute! You can do this by:

- Opening an issue to report a bug or request a new feature.
- Submitting a pull request to add or update content.

## Support

If you have any questions or need further assistance, please reach out to the course instructor. I'm here to help you succeed!
...
**Contact:** For any questions or concerns, please email the course instructor at [sebastianroldan@itm.edu.co].